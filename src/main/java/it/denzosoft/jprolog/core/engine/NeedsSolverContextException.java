 ...
 * {@link BuiltInWithContext} implementation reached without a {@link SolverContext}).
 * {@code core.engine.v4.LegacyBuiltinAdapter} treats it — and only it — as "not bridgeable",
 * falling back to user clauses; every other {@link RuntimeException} escaping a built-in is
 * surfaced as a catchable {@code system_error} instead of being silently swallowed.
 *
