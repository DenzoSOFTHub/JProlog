...
This guide is current as of JProlog v3.6.0. For the most up-to-date class paths and API, refer to the JavaDoc documentation or browse the source code in `src/main/java/it/denzosoft/jprolog/`.