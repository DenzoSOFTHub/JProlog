...
This guide is current as of **JProlog v3.6.0**. All list operations and built-in predicates described are fully functional and tested.

### List Features in v3.6.0:
...
*This comprehensive guide covers all list operations available in JProlog v3.6.0. For additional examples and test cases, see the programs in the `examples/` directory.*