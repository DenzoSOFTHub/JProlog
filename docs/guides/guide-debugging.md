...
This guide is current as of **JProlog v2.5.5**. The debugging features described are fully functional in this version. All examples and procedures have been tested with the current IDE implementation.
