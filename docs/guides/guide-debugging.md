...
This guide is current as of **JProlog v3.0.0**. The debugging features described are fully functional in this version. All examples and procedures have been tested with the current IDE implementation.
