/* ============================================
   ...
   VERSIONE FINALE FUNZIONANTE - Usa helper predicates
   ============================================ */

:- module(dcg_calc, [parse_expr/2, eval/2, calc/2]).

/* ---------- Helper predicates per evitare congiunzioni nei braces ---------- */

% Helper per verificare se un carattere è una cifra
is_digit_char(D) :- D >= 48, D =< 57.

% Helper per verificare se un carattere è uno spazio
is_space_char(C) :- 
    C = 9;    % \t
    C = 10;   % \n  
    C = 11;   % \v
...
% Helper per verificare lista non vuota e convertire
